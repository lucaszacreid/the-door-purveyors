export default function Hero() {
  return (
    <section className="bg-[#1e2d3d] pt-36 md:pt-44 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="font-heading font-bold text-4xl md:text-5xl text-white leading-tight mb-5">
              Door Installation —{' '}
              <span className="text-[#b07d3a]">Full Service, Start to Finish</span>
            </h1>
            ...
            <ul className="space-y-3 mb-10">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-white/75 text-sm font-body">
                  <svg className="w-4 h-4 text-[#b07d3a] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#enquire"
                className="inline-flex items-center justify-center bg-[#b07d3a] hover:bg-[#9a6d31] text-black font-semibold text-sm tracking-wider uppercase px-8 py-4 transition-colors duration-200"
              >
                Get a Free Survey
              </a>
              <a
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.step} className="flex gap-4">
                  <div className="w-7 h-7 bg-[#b07d3a] text-black font-heading font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                    {item.step}
                  </div>
                  <div>
