      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <a
              href="#enquire"
              className="inline-flex items-center gap-2 bg-[#f8cf40] hover:bg-[#e8b830] text-black font-semibold text-sm tracking-wider uppercase px-8 py-4 transition-colors duration-200"
            >
          ...
          <ul className="space-y-3">
            {reasons.map((reason) => (
              <li key={reason.title} className="flex items-start gap-3 text-white/75 text-sm font-body">
                <svg className="w-4 h-4 text-[#f8cf40] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
